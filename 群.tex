...
经过上述讨论我们已经知道,直和$\bigoplus_{i=1}^{s}G_i$的结构完全被群$G_i$的结构决定.因此,如果一个群能够分解成一些群的直和,那么该群的研究就可以归结为另一些群(一般比原来的群简单)的研究.下面将讨论在什么情况下,一个群能够分解成一些群的直和.
\begin{theorem}
    1
\end{theorem}
