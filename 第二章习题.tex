...
\begin{proof}
    设$G$是非交换的$6$阶群.注意到\begin{align*}
        6=2\times3,
    \end{align*}所以由$Sl$第一定理(定理\ref{xldydl})可知$G$有阶为$2$的$\Sl$2-子群$A$,阶为$3$的$\Sl$3-子群$B$,由引理\ref{sdfmk}可知$A,B$都是循环群,故可设\begin{align*}
...
\begin{problem}[P98T33]
    设$G$是有限群,$N\lhd G,P$为$N$的$\Sp$子群,$T$为$P$在$G$中的正规化子.证明$G=NT$.
\end{problem}
\begin{proof}
    \stars
\end{proof}
